...
select
  ...
  sum(v.nxm_in * p.avg_nxm_eth_price) as eth_nxm_in,
  sum(v.nxm_in * p.avg_nxm_usd_price) as usd_nxm_in,
  ...
  sum(v.nxm_out * p.avg_nxm_eth_price) as eth_nxm_out,
  sum(v.nxm_out * p.avg_nxm_usd_price) as usd_nxm_out
