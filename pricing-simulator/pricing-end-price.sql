...
select
  '10%' as depeg_pct,
  (0.02 * sr.p_loss_event_10 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_50pct.time_price_ratio * ps_7d_50pct.deductible_price_ratio as deductible_7d_50pct,
  (0.02 * sr.p_loss_event_10 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_50pct.time_price_ratio * ps_3d_50pct.deductible_price_ratio as deductible_3d_50pct,
  (0.02 * sr.p_loss_event_10 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_25pct.time_price_ratio * ps_7d_25pct.deductible_price_ratio as deductible_7d_25pct,
  (0.02 * sr.p_loss_event_10 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_25pct.time_price_ratio * ps_3d_25pct.deductible_price_ratio as deductible_3d_25pct
...
select
  '15%' as depeg_pct,
  (0.02 * sr.p_loss_event_15 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_50pct.time_price_ratio * ps_7d_50pct.deductible_price_ratio as deductible_7d_50pct,
  (0.02 * sr.p_loss_event_15 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_50pct.time_price_ratio * ps_3d_50pct.deductible_price_ratio as deductible_3d_50pct,
  (0.02 * sr.p_loss_event_15 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_25pct.time_price_ratio * ps_7d_25pct.deductible_price_ratio as deductible_7d_25pct,
  (0.02 * sr.p_loss_event_15 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_25pct.time_price_ratio * ps_3d_25pct.deductible_price_ratio as deductible_3d_25pct
from simulation_results sr
  inner join pricing_setup ps_7d_50pct on ps_7d_50pct.id = 1
  inner join pricing_setup ps_7d_25pct on ps_7d_25pct.id = 2
  inner join pricing_setup ps_3d_50pct on ps_3d_50pct.id = 3
...
select
  '20%' as depeg_pct,
  (0.02 * sr.p_loss_event_20 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_50pct.time_price_ratio * ps_7d_50pct.deductible_price_ratio as deductible_7d_50pct,
  (0.02 * sr.p_loss_event_20 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_50pct.time_price_ratio * ps_3d_50pct.deductible_price_ratio as deductible_3d_50pct,
  (0.02 * sr.p_loss_event_20 / sr.p_loss_event_20) * 1.3/0.9 * ps_7d_25pct.time_price_ratio * ps_7d_25pct.deductible_price_ratio as deductible_7d_25pct,
  (0.02 * sr.p_loss_event_20 / sr.p_loss_event_20) * 1.3/0.9 * ps_3d_25pct.time_price_ratio * ps_3d_25pct.deductible_price_ratio as deductible_3d_25pct
from simulation_results sr
  inner join pricing_setup ps_7d_50pct on ps_7d_50pct.id = 1
  inner join pricing_setup ps_7d_25pct on ps_7d_25pct.id = 2
  inner join pricing_setup ps_3d_50pct on ps_3d_50pct.id = 3
