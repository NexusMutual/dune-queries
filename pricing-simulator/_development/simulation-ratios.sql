...
select
  ...
  p_loss_event_10 / p_loss_event_20_baseline as ratio_10,
  p_loss_event_15 / p_loss_event_20_baseline as ratio_15,
  p_loss_event_20 / p_loss_event_20_baseline as ratio_20 
from simulation_results
union all
select
