...
select
  '10%' as depeg_pct,
  0.02 * p_loss_event_10 / p_loss_event_20 as p_event,
  p_loss_event_10 / p_loss_event_20 as ratio
from simulation_results
union all
select
  '15%' as depeg_pct,
  0.02 * p_loss_event_15 / p_loss_event_20 as p_event,
  p_loss_event_15 / p_loss_event_20 as ratio
from simulation_results
union all
select
  '20%' as depeg_pct,
  0.02 * p_loss_event_20 / p_loss_event_20 as p_event,
  p_loss_event_20 / p_loss_event_20 as ratio
from simulation_results
order by 1
