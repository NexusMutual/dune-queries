with
  ...
  net_totals as (
    select
      ...
      product_name,
      product_type,
      SUM(staked_amount - unstaked_amount) OVER (PARTITION BY product_name) as total_staked_amount_per_product,
      staked_amount - unstaked_amount as day_staked,
...
SELECT
  ...
  product_type,
  day_staked,
  total_staked_amount_per_product,
